      ...
      <div className='flex items-center gap-6'>
            ...
            <div className='group relative' >
                ...
                <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                    <div className='fex fex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded'>
        ...
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
            ...
            <div className='flex flex-col text-grey-600'>
                ...
                <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 border' to='/About'>ABOUTE</NavLink>
